...
def _code_block_():
    ...
    alpha_064 = if_else(cs_rank(ts_corr(ts_sum(OPEN * 0.178404 + LOW * (1 - 0.178404), 13), ts_sum(ADV120, 13), 17)) < cs_rank(ts_delta((HIGH + LOW) / 2 * 0.178404 + VWAP * (1 - 0.178404), 4)), 1, 0) * -1
    alpha_065 = if_else(cs_rank(ts_corr(OPEN * 0.00817205 + VWAP * (1 - 0.00817205), ts_sum(ADV60, 9), 6)) < cs_rank(OPEN - ts_min(OPEN, 14)), 1, 0) * -1
    ...
    alpha_068 = if_else(ts_rank(ts_corr(cs_rank(HIGH), cs_rank(ADV15), 9), 14) < cs_rank(ts_delta(CLOSE * 0.518371 + LOW * (1 - 0.518371), 1)), 1, 0) * -1
    ...
    alpha_074 = if_else(cs_rank(ts_corr(CLOSE, ts_sum(ADV30, 37), 15)) < cs_rank(ts_corr(cs_rank(HIGH * 0.0261661 + VWAP * (1 - 0.0261661)), cs_rank(VOLUME), 11)), 1, 0) * -1
    ...
    alpha_081 = if_else(cs_rank(log(ts_product(cs_rank(cs_rank(ts_corr(VWAP, ts_sum(ADV10, 50), 8)) ** 4), 15))) < cs_rank(ts_corr(cs_rank(VWAP), cs_rank(VOLUME), 5)), 1, 0) * -1
    ...
    alpha_086 = if_else(ts_rank(ts_corr(CLOSE, ts_sum(ADV20, 15), 6), 20) < cs_rank(OPEN + CLOSE - (VWAP + OPEN)), 1, 0) * -1
    ...
    alpha_095 = cs_rank(OPEN - ts_min(OPEN, 12)) < ts_rank(cs_rank(ts_corr(ts_sum((HIGH + LOW) / 2, 19), ts_sum(ADV40, 19), 13)) ** 5, 12)
    ...
    alpha_099 = if_else(cs_rank(ts_corr(ts_sum((HIGH + LOW) / 2, 20), ts_sum(ADV60, 20), 9)) < cs_rank(ts_corr(LOW, VOLUME, 6)), 1, 0) * -1
